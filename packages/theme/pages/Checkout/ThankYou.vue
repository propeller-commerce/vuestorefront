...
export default {
  ...
  setup(props, context) {
    ...
    // TODO: Check if payment is success before clearing the cookie
    // TODO: this sucks, call useCart and clear the cart properly

    clear();
    // const cookie = CookieUniversal();

    // const baseSetCookieOptions = {
    //   sameSite: 'lax',
    //   path: '/',
    // };
    // cookie.remove('propeller-vsf-cart', {
